...
<div id="content"> <!-- Inicio del Contenido (Menu) --> 
    ...
    <form action="informe_indicador1_dia.php" method="post">
            ...
            <tr class="success">
                    ...
                    <?php 
						...
						foreach ($consulta as $row): 
							...
							$r=1;
							$t=1;
							$tr=$row1['minutos'];if($tr==NULL){$tr=0;}else{$tr=$tr;}	
							$tp=$row1['time_categoria'];if($tp==NULL){$tp=0;}else{$tp=$tp;}
					 ...
					 ?>
                        ...
                        <td  ><?php echo $t; ?></td>
                        <td  ><?php echo $r; ?></td>
                        <td  ><?php echo number_format($tr,1); ?></td>
                        <td  ><?php echo $tp; ?></td>
