...
$rpta = ActualizarIncidenciaEstado($id_incidencia,$id_cliente,$det,$id_usuario,$id_tipo_solicitud,$id_modo,$id_impacto,$id_prioridad,$id_categoria_detalle,$niv,$asu,$des,$hora_ini,$act);
...
//window.close();
alert("Se cambio de estado correctamente!!!");
