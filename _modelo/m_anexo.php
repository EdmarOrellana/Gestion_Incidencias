...
WHERE nom_anexo LIKE '$d%' AND act_anexo='$a'
ORDER BY nom_anexo ASC";
}
...
//-------------------------------------------------------------------------------------------------------
function GrabarAnexo($nom)
{
include("../conexion/conexion.php");

	//Verificar si existe este anexo 
	$sqlv="SELECT * FROM anexo WHERE nom_anexo='$nom'";
	$resv=mysql_query($sqlv,$con);
	$rowv=mysql_fetch_array($resv);
	if($rowv['id_anexo']!=NULL)
	{
	return $rpta="NO";
	}
	...
	{
	$sql="INSERT INTO anexo() VALUES(NULL,'$nom',1)";
	mysql_query($sql,$con);	
	return $rpta="SI";
	}
...
//-------------------------------------------------------------------------------------------------------
function ConsultarAnexo($cod)
{
include("../conexion/conexion.php");

$sql="SELECT * FROM anexo WHERE id_anexo='$cod'"; 
...
function ActualizarAnexo($id_anexo,$nom,$act,$e)
{
include("../conexion/conexion.php");
...
include("../conexion/conexion.php");
	...
	$sqlg="DELETE FROM anexo WHERE id_anexo='$id_anexo'";
	mysql_query($sqlg,$con);
