...
function MostrarTipoSolicitud($p,$d,$a)
{
...
WHERE nom_tipo_solicitud LIKE '$d%' AND act_tipo_solicitud='$a'
ORDER BY nom_tipo_solicitud ASC";
}
...
function MostrarTipoSolicitud1()
{
include("../conexion/conexion.php");
...
//-------------------------------------------------------------------------------------------------------
function GrabarTipoSolicitud($nom)
{
include("../conexion/conexion.php");

	//Verificar si existe este tipo_solicitud 
	$sqlv="SELECT * FROM tipo_solicitud WHERE nom_tipo_solicitud='$nom'";
	$resv=mysql_query($sqlv,$con);
	$rowv=mysql_fetch_array($resv);
	if($rowv['id_tipo_solicitud']!=NULL)
	{
	return $rpta="NO";
	}
	...
	{
	$sql="INSERT INTO tipo_solicitud() VALUES(NULL,'$nom',1)";
	mysql_query($sql,$con);	
	return $rpta="SI";
	}
...
//-------------------------------------------------------------------------------------------------------
function ConsultarTipoSolicitud($cod)
{
include("../conexion/conexion.php");

$sql="SELECT * FROM tipo_solicitud WHERE id_tipo_solicitud='$cod'"; 
...
function ActualizarTipoSolicitud($id_tipo_solicitud,$nom,$act,$e)
{
include("../conexion/conexion.php");
	...
	$resv=mysql_query($sqlv,$con);
	$rowv=mysql_fetch_array($resv);
	$cp=$rowv['nom_tipo_solicitud'];
	
	if($cp==NULL || ($cp==$e))
	{
	$sqlg="UPDATE tipo_solicitud SET 
	nom_tipo_solicitud='$nom',
	act_tipo_solicitud='$act'
...
function EliminarTipoSolicitud($id_tipo_solicitud)
{
include("../conexion/conexion.php");

	$sqlg="DELETE FROM tipo_solicitud WHERE id_tipo_solicitud='$id_tipo_solicitud'";
	mysql_query($sqlg,$con);
