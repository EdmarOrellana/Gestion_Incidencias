...
function MostrarCategoriaDetalle($p,$d,$a)
{
include("../conexion/conexion.php");

if($p=="NOM")
{
$sql="SELECT * FROM categoria_detalle 
INNER JOIN categoria ON categoria_detalle.id_categoria=categoria.id_categoria
WHERE nom_categoria_detalle LIKE '$d%' AND act_categoria_detalle='$a'
ORDER BY nom_categoria,nom_categoria_detalle ASC";
}
...
function MostrarCategoriaDetalle1()
{
include("../conexion/conexion.php");
...
include("../conexion/conexion.php");
	...
	if($rowv['id_categoria_detalle']!=NULL)
	{
	return $rpta="NO";
	}
	...
	{
	$sql="INSERT INTO categoria_detalle() VALUES(NULL,'$cat','$gru','$nom',1)";
	mysql_query($sql,$con);	
	return $rpta="SI";
	}
...
//-------------------------------------------------------------------------------------------------------
function ConsultarCategoriaDetalle($cod)
{
include("../conexion/conexion.php");

$sql="SELECT * FROM categoria_detalle 
INNER JOIN categoria ON categoria_detalle.id_categoria=categoria.id_categoria
WHERE id_categoria_detalle='$cod'"; 
...
function EliminarCategoriaDetalle($id_categoria_detalle)
{
include("../conexion/conexion.php");
	
	$sqlx="DELETE FROM categoria_detalle WHERE id_categoria_detalle='$id_categoria_detalle'";
...
//--------------------------------------------------------------------------------------------------------------------------
function BuscarCategoriaDetalle()
{
include("../conexion/conexion.php");

$sql="SELECT * FROM categoria_detalle 
INNER JOIN categoria ON categoria_detalle.id_categoria=categoria.id_categoria
WHERE act_categoria_detalle=1";
...
function BuscarCategoriaDetalle1($d)
{
include("../conexion/conexion.php");

$sql="SELECT * FROM categoria_detalle 
INNER JOIN categoria ON categoria_detalle.id_categoria=categoria.id_categoria
WHERE (nom_categoria_detalle LIKE '%$d%' OR  nom_categoria LIKE '%$d%' OR  nom_grupo LIKE '%$d%') AND act_categoria_detalle=1";
...
//-------------------------------------------------------------------------------------------------------
function SeleccionarCategoriaDetalle($cod)
{
include("../conexion/conexion.php");
