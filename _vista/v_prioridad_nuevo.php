...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->      
 ...
 <div class="panel-heading">Nuevo Prioridad</div>
        
        
   <div class="modal-body">
   
   
 <form action="prioridad_nuevo.php" method="POST" name="prioridad_nuevo" autocomplete="off">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    ...
    <td width="80%" align="left"> <input name="nom" type="text" class="form-control input-sm"   placeholder="Prioridad" required="required" maxlength="50"  /></td>
  </tr>
