...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
  ...
  <tr>
    ...
    <td width="80%" align="left"> <input name="pass" value="<?php echo $pass; ?>" type="password" class="form-control input-sm"   placeholder="Contraseña" required="required" maxlength="20"  /></td>
  </tr>
