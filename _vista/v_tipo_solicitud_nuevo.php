...
<title>Nueva Tipo Solicitud</title>
...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->      
 ...
 <div class="panel-heading">Nuevo Tipo Solicitud</div>
        
        
   <div class="modal-body">
   
   
 <form action="tipo_solicitud_nuevo.php" method="POST" name="tipo_solicitud_nuevo" autocomplete="off">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    ...
    <td width="80%" align="left"> <input name="nom" type="text" class="form-control input-sm"   placeholder="TipoSolicitud" required="required" maxlength="50"  /></td>
  </tr>
