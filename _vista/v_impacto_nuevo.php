...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->      
 ...
 <div class="panel-heading">Nuevo Impacto</div>
        
        
   <div class="modal-body">
   
   
 <form action="impacto_nuevo.php" method="POST" name="impacto_nuevo" autocomplete="off">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    ...
    <td width="80%" align="left"> <input name="nom" type="text" class="form-control input-sm"   placeholder="Impacto" required="required" maxlength="50"  /></td>
  </tr>
