...
$nom=$datos['nom_prioridad'];
$act=$datos['act_prioridad'];
endforeach; 
?>
...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->    
 ...
 <div class="panel-heading" >Editar Prioridad</div>
        
        
   <div class="modal-body">
   
   
 <form action="prioridad_editar.php" method="POST" name="prioridad_editar" autocomplete="off" enctype="multipart/form-data">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    <td width="20%" align="left"><strong>Prioridad:&nbsp;</strong></td>
    <td width="80%" align="left"> <input name="nom" value="<?php echo $nom; ?>" type="text" class="form-control input-sm"   placeholder="Prioridad" required="required" maxlength="50"  /></td>
  </tr>
...
<hr width="100%" />
  ...
  <!-- <a href="transporte_mostrar.php" class="btn" style="color:#060">Ir a listado</a> -->
   ...
   <!-- ----------------------------------------------------------------------------------------------------------------- -->   
<!-- Codigos ocultos -->
<input type="text" name="id_prioridad" size="2"  value="<?php echo $id_prioridad; ?>" style="visibility:hidden"/>  
