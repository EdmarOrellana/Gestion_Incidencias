...
$nom=$datos['nom_impacto'];
$act=$datos['act_impacto'];
endforeach; 
?>
...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->    
 ...
 <div class="panel-heading" >Editar Impacto</div>
        
        
   <div class="modal-body">
   
   
 <form action="impacto_editar.php" method="POST" name="impacto_editar" autocomplete="off" enctype="multipart/form-data">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    <td width="20%" align="left"><strong>Impacto:&nbsp;</strong></td>
    <td width="80%" align="left"> <input name="nom" value="<?php echo $nom; ?>" type="text" class="form-control input-sm"   placeholder="Impacto" required="required" maxlength="50"  /></td>
  </tr>
...
<hr width="100%" />
  ...
  <!-- <a href="transporte_mostrar.php" class="btn" style="color:#060">Ir a listado</a> -->
   ...
   <!-- ----------------------------------------------------------------------------------------------------------------- -->   
<!-- Codigos ocultos -->
<input type="text" name="id_impacto" size="2"  value="<?php echo $id_impacto; ?>" style="visibility:hidden"/>  
