...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="80%" align="left"> <input name="pass" type="password" value="<?php echo $pass; ?>" class="form-control input-sm"   placeholder="Contraseña" required="required" maxlength="50"  /></td>
  </tr>
