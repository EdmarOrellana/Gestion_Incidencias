...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="80%" align="left"> <input name="dir" type="text" class="form-control input-sm"   placeholder="Direccion" required="required"  maxlength="100"  /></td>
  </tr>
  
  
             <tr>
    <td width="20%" align="left"><strong>Teléfono:&nbsp;</strong></td>
    <td width="80%" align="left"> <input name="tel" type="text" class="form-control input-sm"   placeholder="Telefono" maxlength="7" required="required" onKeyPress="return justNumbers(event);"   /></td>
  </tr>
  
             <tr>
    <td width="20%" align="left"><strong>Celular:&nbsp;</strong></td>
    <td width="80%" align="left"> <input name="cel" type="text" class="form-control input-sm"   placeholder="Celular" maxlength="9" required="required" onKeyPress="return justNumbers(event);"  /></td>
  </tr>
   ...
   <tr>
    ...
    <td width="80%" align="left"> <input name="pass" type="text" class="form-control input-sm"   placeholder="Contraseña" required="required" maxlength="50"  /></td>
  </tr>
