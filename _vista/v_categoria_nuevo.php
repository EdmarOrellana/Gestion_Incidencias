...
<!-- ---------------------------------------------------------------------------------------------------------------------- -->      
 ...
 <form action="categoria_nuevo.php" method="POST" name="categoria_nuevo" autocomplete="off">  
...
<table border="0" WIDTH=800 class="table-responsive table-hover table-condensed " >
   ...
   <tr>
    ...
    <td width="80%" align="left"> <input name="nom" type="text" class="form-control input-sm"   placeholder="Categoria" required="required" maxlength="50"  /></td>
  </tr>
  
     <tr>
    <td width="20%" align="left"><strong>Tiempo (min):&nbsp;</strong></td>
    <td width="80%" align="left"> <input name="tiempo" type="number" class="form-control input-sm"   placeholder="Tiempo (min)" required="required" min="1" step="1" /></td>
  </tr>
